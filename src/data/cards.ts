...
const neverBase: Record<Vibe, string[]> = {
  ...
  hot: [
    ...
    "embrassé quelqu'un juste pour voir ce que ça faisait",
    "eu un crush sur quelqu'un que tu ne devrais pas",
    "stalké le profil d'un ex à 3h du matin",
    "envoyé un message de drague et regretté immédiatement",
    "fantasmé sur quelqu'un présent dans cette pièce",
    "fait semblant de dormir pour éviter une conversation intime",
    "eu un moment de tension avec un(e) ami(e) qui était plus qu'amical",
    "flirté avec quelqu'un juste pour rendre jaloux quelqu'un d'autre",
    "gardé un souvenir intime d'un ex que tu aurais dû supprimer",
    "dit 'je t'aime' sans le penser vraiment",
  ],
  chaos: [
